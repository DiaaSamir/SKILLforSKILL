...
const user_signup_scehma = Joi.object({
  first_name: Joi.string().min(5).max(50).required().messages({
    'string.min': 'Your first name must be at least 5 characters',
    'string.max': 'Your first name can be 50 characters at maximum',
    'any.required': 'First name is required!',
  }),

  last_name: Joi.string().min(5).max(50).required().messages({
    'string.min': 'Your last name must be at least 5 characters',
